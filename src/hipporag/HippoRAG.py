...
class HippoRAG:
    ...
    def __init__(self,
        ...
        if self.global_config.openie_mode == 'online':
            self.openie = OpenIE(llm_model=self.llm_model, max_workers=self.global_config.ie_max_workers, graph_entity_config=graph_entity_config)
